...
Algorythm includes high-quality presets:
...
# Advanced presets
organ = SynthPresets.organ()        # Additive synth
bell = SynthPresets.bell()          # FM synth
strings = SynthPresets.strings()    # Pad synth
guitar = SynthPresets.guitar()      # Physical model
drum = SynthPresets.drum()          # Physical model
brass = SynthPresets.brass()        # FM synth
